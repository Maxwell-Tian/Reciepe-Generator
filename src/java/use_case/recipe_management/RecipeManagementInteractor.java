...
//
////        Map<String, List<String>> recommendations = recommendRecipes(userIngredients, allRecipes);
//
//        outputBoundary.presentRecipes(allRecipes);
...
//    }
    // TODO: feel like this chunk of code is useless right now since the algorithm is done in API
